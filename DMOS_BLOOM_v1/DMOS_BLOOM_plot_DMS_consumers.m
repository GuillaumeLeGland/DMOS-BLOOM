...
hold on
for b = 1:8
    plot(day_Meth(b,:),Meth_free(b,:),lineType{b},'MarkerSize',6,'Color',color(b,:),'MarkerFaceColor',faceColor(b,:),'LineWidth',2);
end
xlim([0 ndays])
ylim([0 0.016])
ymax = 0.016;
...
hold on
for b = 1:8
    plot(day_Meth(b,:),Meth_part(b,:),lineType{b},'MarkerSize',6,'Color',color(b,:),'MarkerFaceColor',faceColor(b,:),'LineWidth',2);
end
xlim([0 ndays])
ylim([0 0.06])
ymax = 0.06;
