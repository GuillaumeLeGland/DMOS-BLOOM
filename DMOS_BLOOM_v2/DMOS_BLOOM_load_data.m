function [day,Ehux,nano,pico,Syn,bac,EhV,MpV,cil,thr,IEC,NO3,Chl,DMS,DMSPd_raw,DMSPd,DMSPp,PON] = DMOS_BLOOM_load_data()

%========================================================================

ncol  = 23; % Number of dataset columns to read
...
fid = fopen('DATA/BERGEN-DATA-NEW.csv','r');
fgetl(fid);
D=textscan(fid,repmat('%s ',1,ncol), 'delimiter', ';');
fclose(fid);

index_var = [2,3,4,5,6,7,8,9,11,12,13,14,15,16,18,21,23]; % List of columns to be read
