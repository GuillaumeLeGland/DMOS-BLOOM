...
% Use grey for bags with no viral infection (reviewer #1 recommendation, 25/01/2023)
...
legend({'Bag 1              ','Bag 2              ','Bag 3              ','Bag 4 (Late lysis)','Bag 5              ',...
        'Bag 6              ','Bag 7 (Early lysis)','Fjord              '},'Location','NorthWest')
set(gca,'fontsize',15); 
subplot(2,2,3)
